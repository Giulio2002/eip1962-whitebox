...
HFUZZ_RUN_ARGS="-u -V -n 12 --tmout_sigvtalrm --max_file_size 16000" cargo hfuzz run-debug fuzz_target_api SIGABRT.EXC_CRASH.PC.00007fff6eccb49a.STACK.000000011edb025c.ADDR.0000000000000000.TIME.2020-02-04.15.51.26.PID.20410.fuzz # --no-default-features --features=macos